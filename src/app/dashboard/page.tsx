      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#121829] border border-[#00be64]/30 rounded-2xl shadow-xl p-8 relative overflow-hidden col-span-2">
          ...
          <p className="text-gray-300 max-w-3xl text-lg leading-relaxed relative z-10">
            Discovery is your all-in-one <span className="text-white font-semibold">Soil Intelligence Platform</span>,
            helping you monitor soil health, track paddock performance, and make data-driven decisions with real-time 
            insights from your on-ground sensors.
          </p>

          <p className="mt-3 text-gray-400 max-w-2xl relative z-10">
            Whether you're analysing moisture, temperature, or nutrient trends, Discovery gives you the tools to farm 
            smarter — not harder.
          </p>
...
<section className="bg-[#121829] border border-[#00be64]/30 rounded-2xl shadow-xl p-8 relative overflow-hidden">
  ...
  <h2 className="text-2xl font-bold mb-4 relative z-10">
    Learn How to Get the Most From <span className="text-[#00be64]">Discovery</span>
  </h2>

  <p className="text-gray-300 mb-8 max-w-3xl relative z-10">
    Whether you're new to soil monitoring or looking to sharpen your agronomy skills,
    these guides will help you get more value from your sensors, paddocks, and soil intelligence data.
  </p>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
    ...
    <div className="bg-[#0f1525] border border-[#00be64]/20 rounded-xl p-6 hover:border-[#00be64]/40 transition shadow-lg">
      <h3 className="text-xl font-semibold mb-2">📡 Understanding Your Sensors</h3>
      <p className="text-gray-400 text-sm mb-4">
        Learn how your Discovery probes capture soil moisture, pH, and temperature data.
      </p>
    ...
    {/* Card 2 */}
    <div className="bg-[#0f1525] border border-[#00be64]/20 rounded-xl p-6 hover:border-[#00be64]/40 transition shadow-lg">
      <h3 className="text-xl font-semibold mb-2">🌱 Improving Soil Health</h3>
      <p className="text-gray-400 text-sm mb-4">
        Practical steps to increase microbial activity, fertility, and long-term soil resilience.
      </p>
      <button className="text-[#00be64] hover:text-[#00d978] font-medium text-sm">
        Learn how →
      </button>
    ...
    {/* Card 3 */}
    <div className="bg-[#0f1525] border border-[#00be64]/20 rounded-xl p-6 hover:border-[#00be64]/40 transition shadow-lg">
      <h3 className="text-xl font-semibold mb-2">📊 Using Data for Better Decisions</h3>
      <p className="text-gray-400 text-sm mb-4">
        Turn your real-time measurements into meaningful farm insights and crop strategies.
      </p>
      <button className="text-[#00be64] hover:text-[#00d978] font-medium text-sm">
        Start learning →
      </button>
