      ...
      >
        ...
        <div className="relative border-b border-[#00be64]/20 p-8 bg-gradient-to-br from-[#00be64]/5 to-transparent">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-1">Edit Zone</h2>
              <p className="text-gray-400 text-sm">Update zone information</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 flex items-center gap-1.5">
              ...
              Enter the zone area in hectares
            </p>
          </div>
